...
export default class Sort extends AbstractComponent {
  ...
  // Реализация сортировки. Инкапсулируем логику получения типа сортировки из разметке в компоненте, и в обработчик будем передавать полученный тип. А обработчик на основе типа сортировки будет сортировать задачи и перерендеривать их
  getSortType() {
